...
class MessageType(str, Enum):
    ...
    TTS_PRELOAD_RESPONSE = "tts_preload_response"
...
class TTSSpeakMessage:
    ...
    @classmethod
    def from_payload(cls, payload: dict) -> "TTSSpeakMessage":
        return cls(
            text=payload["text"],
...
class TTSStopMessage:
    ...
    @classmethod
    def from_payload(cls, payload: dict) -> "TTSStopMessage":
        return cls()
...
class TTSStatusMessage:
    ...
    @classmethod
    def from_payload(cls, payload: dict) -> "TTSStatusMessage":
        return cls(
            state=payload["state"],
...
class TTSSetVoiceMessage:
    ...
    @classmethod
    def from_payload(cls, payload: dict) -> "TTSSetVoiceMessage":
        return cls(
...
class TTSVoiceConfigMessage:
    ...
    @classmethod
    def from_payload(cls, payload: dict) -> "TTSVoiceConfigMessage":
        return cls(
            language=payload["language"],
            voice_instruct=payload["voice_instruct"],
            preset_name=payload.get("preset_name"),
            available_presets=payload.get("available_presets")
        )


@dataclass
class TTSPreloadMessage:
    """TTS preload request (CLI -> Backend) to warm up the model."""

    def to_ipc_message(self) -> IPCMessage:
        return IPCMessage(
            type=MessageType.TTS_PRELOAD,
            payload={}
        )

    @classmethod
    def from_payload(cls, payload: dict) -> "TTSPreloadMessage":
        return cls()


@dataclass
class TTSPreloadResponseMessage:
    """TTS preload response (Backend -> CLI) after model is loaded."""
    success: bool
    error: Optional[str] = None

    def to_ipc_message(self) -> IPCMessage:
        return IPCMessage(
            type=MessageType.TTS_PRELOAD_RESPONSE,
            payload={"success": self.success, "error": self.error}
        )

    @classmethod
    def from_payload(cls, payload: dict) -> "TTSPreloadResponseMessage":
        return cls(
